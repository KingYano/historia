...
export const paintingsData: Painting[] = [
    ...
    },
    {
        ...
        firstParagraph: '"Riding with Death" is a remarkable painting by Jean-Michel Basquiat, created in 1988. It depicts a skeletal figure riding a horse-like creature, often interpreted as a representation of death. This work reflects Basquiat\'s interest in themes of mortality, legacy, and the human experience, characterized by his raw and vibrant style. It is seen as a commentary on the inevitability of death and the artist\'s contemplation of his own life and mortality.',
        secondParagraph: 'The painting delves deeper into Basquiat\'s reflections on human vulnerability and the struggle against the invisible forces of life and death. With its minimalist aesthetic and powerful symbolism, the artwork showcases Basquiat\'s unique style, blending elements of graffiti, primitive art, and expressionism. The apparent simplicity of the composition contrasts with the complexity of the themes addressed, offering rich material for interpretation on the human condition and the omnipresent presence of death in life.',
